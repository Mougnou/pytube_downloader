...
class DownloaderApp(ct.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.subtitle_label = ct.CTkLabel(self, text="Subtitle :")
        self.subtitle_label.grid(row=3, column=0, padx=10, pady=10)
        self.subtitle_combobox = ct.CTkComboBox(self,state="disabled", values=[""])
        self.subtitle_combobox.grid(row=3, column=1, padx=10, pady=10,columnspan=2, sticky="we")


        self.path_label = ct.CTkLabel(self, text="Path :")
        self.path_label.grid(row=4, column=0, padx=10, pady=10)
        ...
        self.download_button.grid(row=5, column=0, padx=10, pady=10, columnspan=3, sticky="we")

        self.download_subtitle_button = ct.CTkButton(self, text="Download Subtitle Only", state="disabled")
        self.download_subtitle_button.grid(row=6, column=0, padx=10, pady=10, columnspan=3, sticky="we")

        self.progress_bar = ttk.Progressbar(self, length=200)
        self.progress_bar.grid(row=7, column=0,  padx=10, pady=10, sticky="we",columnspan=3)
    ...
    def open_directory(self):
        ...
        self.download_subtitle_button.configure(state="normal")